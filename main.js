...
var _parseContentRegions = (content) => {
  if (!content) {
...
var generateTagPageContent = async (app, settings, tagsInfo, tagOfInterest, previousContent) => {
...
var TagPagePlugin = class extends import_obsidian2.Plugin {
  ...
  async refreshTagPageContent() {
    ...
    await this.app.fileManager.processFrontMatter(activeLeaf.file, (frontMatter) => {
      ...
      const updatedTags = new Set(frontMatter.tags);
